...
- Conecta el **sensor GUVA-S12SD** al pin 34 del ESP32 para medir radiación UV.
- Conecta el **Display OLED SSD1306** a los pines I2C del ESP32 para mostrar las lecturas.
- Conecta el ESP32 a la red Wi-Fi usando las siguientes credenciales:
  ```cpp
...
### 2. Cargar el código en el ESP32
    ...
    Abre ArduinoProyecto.cpp en el IDE de Arduino y carga el código en el ESP32.
    Asegúrate de tener instaladas las bibliotecas necesarias (Adafruit_GFX, Adafruit_SSD1306, WiFi, HTTPClient).

### 3. Configurar la base de datos PostgreSQL

    Ejecuta el script TablasPosgreSQL.sql para crear las tablas necesarias en PostgreSQL.
    Carga los datos iniciales desde uv_index_lima.csv en la base de datos.

### 4. Ejecutar la aplicación Flask

    Instala las dependencias necesarias (Flask y SQLAlchemy).
    Verifica que la URI de la base de datos en app.py sea correcta:
...
### 5. Modelo de predicción
    ...
    Asegúrate de que los archivos uv_index_model.pkl y scaler.pkl estén en la misma carpeta que app.py para realizar las predicciones de índice UV.
